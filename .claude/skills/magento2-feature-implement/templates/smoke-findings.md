...
| F3 | High | frontend | 1 | 3 | S7 | New My Account tab "Vehicles" fails to load — uncaught reference error in vehicle.js | magento2-frontend-create (augment) | — | Still open; cap reached |
