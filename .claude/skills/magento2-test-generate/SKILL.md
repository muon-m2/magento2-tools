...
Per module, run `scripts/coverage-gap.sh <module-path>` to identify:
...
src/app/code/{Vendor}/{Module}/Test/Integration/...
src/app/code/{Vendor}/{Module}/Test/Api/...
src/app/code/{Vendor}/{Module}/view/.../web/js/test/...
...
- `scripts/coverage-gap.sh` — find untested source classes and surface them by type.
