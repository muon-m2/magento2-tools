...
description:
  ...
  deploy report. Used by magento2-tools:feature, magento2-tools:fix, and
  magento2-tools:upgrade for their D* deploy step.
---
...
Invoke `context`. Capture `runner`, `magento_cli`, `composer`. If `magento_cli`
...
Orchestrators such as `feature` pass this to collect a run's
...
| Caller                       | Use                                                        |
|------------------------------|------------------------------------------------------------|
| `feature` | Phase 5 D1 task                                            |
| `fix`           | Phase 6 (optional)                                         |
| `upgrade`    | After upgrade is patched                                   |
| `release`           | Phase 2 (validate only — `--strict` pre-flight)            |
