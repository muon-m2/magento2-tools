...
Date: {YYYY-MM-DD}
Status: Complete
Implemented by: Claude Code using `feature`
...
2. Run `review` for any module reviewed only quickly during Phase 5.
...
|----|----------|----------|------------------|--------------|-------|
| F1 | Critical | rest_contract | 3 | fix | ACL missing in webapi.xml |
