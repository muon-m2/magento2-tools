 ...
 * the return type so consumers (and the Web API schema) get {EntityName}Interface[] without a
 * runtime cast. Wire the preference to \Magento\Framework\Api\SearchResults in di.xml.
 *
 * @api
 */
